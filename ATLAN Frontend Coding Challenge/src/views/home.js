  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="logo">AI MODELS</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <span className="bodySmall">Home</span>
              <span className="home-nav22 bodySmall">Models</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav221 bodySmall">Models</span>
                <span className="home-nav321 bodySmall">Case Studies</span>
      ...
      <div className="home-hero">
        <div className="home-hero1 heroContainer">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">Explore AI Models</h1>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Explore the Power of AI Models
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the capabilities of AI models in various domains
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Identify objects and patterns in images"
              ></FeatureCard>
              <FeatureCard
                heading="Natural Language Processing"
                subHeading="Understand and generate human language"
              ></FeatureCard>
              <FeatureCard
                heading="Predictive Analytics"
                subHeading="Forecast trends and outcomes based on data"
              ></FeatureCard>
              <FeatureCard
                heading="Anomaly Detection"
                subHeading="Identify outliers and unusual patterns in data"
              ></FeatureCard>
            </div>
          </div>
        </div>
            ...
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">
                  Get started with our AI models for free
                </span>
              </div>
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Access to basic AI models</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Limited usage</span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">Community support</span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container18">
                  ...
                  <span className="bodySmall">Increased usage limits</span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Access to premium AI models</span>
                </div>
                <div className="home-container26">
                  <span className="home-text65">✔</span>
                  <span className="bodySmall">Unlimited usage</span>
                </div>
                ...
                <div className="home-container28">
                  ...
                  <span className="bodySmall">Custom analytics</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Explore a diverse range of AI models deployed by leading
                  organizations and developers. From image recognition to
                  natural language processing, unleash the power of artificial
                  intelligence in your projects.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="An AI model is a mathematical representation of a real-world process that is used by machines to make predictions or decisions."
                question="What is an AI model?"
              ></Question1>
              <Question1
                answer="AI models are deployed by organizations and developers through various platforms and frameworks, such as cloud services or on-premise servers."
                question="How are AI models deployed?"
              ></Question1>
              <Question1
                answer="Common types of AI models include neural networks, decision trees, support vector machines, and deep learning models."
                question="What are the common types of AI models?"
              ></Question1>
              <Question1
                answer="Organizations can benefit from deploying AI models by automating tasks, improving decision-making processes, and gaining insights from large datasets."
                question="How can organizations benefit from deploying AI models?"
              ></Question1>
              <Question1
                answer="AI models are not always accurate and may require continuous training and monitoring to improve their performance over time."
                question="Are AI models always accurate?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">Home</span>
              <span className="home-nav222 bodySmall">Models</span>
              <span className="home-nav322 bodySmall">Case Studies</span>
